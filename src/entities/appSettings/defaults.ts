...
export const APP_SETTING_KEYS = {
  ...
  boxIconFadeOutMs: "boxIconFadeOutMs",
  boxAcrylicEnabled: "boxAcrylicEnabled",
  boxExpandHoverDelayMs: "boxExpandHoverDelayMs",
  boxIconHoverExpandEnabled: "boxIconHoverExpandEnabled",
...
export const DEFAULT_APP_SETTINGS: AppSettings = {
  ...
  boxTitleTextSize: 13,
  boxIconFadeInMs: 160,
  boxIconFadeOutMs: 160,
  boxExpandHoverDelayMs: 100,
  boxIconHoverExpandEnabled: true,
  boxIconGapX: 6,
  boxIconGapY: 4,
  boxFilenameWidth: 82,
  boxCornerRadius: 8,
...
export const APP_SETTING_NUMBER_LIMITS = {
  ...
  boxIconFadeInMs: { min: 60, max: 600, step: 20, unit: "ms" },
  boxIconFadeOutMs: { min: 40, max: 600, step: 20, unit: "ms" },
  boxExpandHoverDelayMs: { min: 0, max: 800, step: 20, unit: "ms" },
